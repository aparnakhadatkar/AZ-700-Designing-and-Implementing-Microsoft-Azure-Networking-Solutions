...
1. On the Azure Portal home page, select **Virtual network** and Verify that the **CoreServicesVnet**, **ManufacturingVnet**, and **ResearchVnet** are listed.

2. Note that Azure creates NetworkWatchers for each region that you use.
...
6. Repeat steps 4 -6 for each VNet.
