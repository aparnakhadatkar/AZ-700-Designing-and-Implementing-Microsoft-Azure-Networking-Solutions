...
1. On the Azure portal home page, select **+ Create a resource**, on the search bar of **Marketplace** page, search and select **Web App** click **Create and Web App** (if this resource type is not listed on the page, use the search box at the top of the page to search for **App service** and select **+ Create** and **+ Web App**).
